...
class Zookeeper(db.Model, SerializerMixin):
    ...
    # To avoid any errors involving recursion depth, we can set the serialize_rules class attribute in each of our models. 
...
class Enclosure(db.Model, SerializerMixin):
    ...
    # To avoid any errors involving recursion depth, we can set the serialize_rules class attribute
